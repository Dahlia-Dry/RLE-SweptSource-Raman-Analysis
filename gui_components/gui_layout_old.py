...
data_modifications = ['revert to original','change filter wavelength','reshape data','remove samples','remove wavelengths']
data_processing = []
...
content= html.Div(children=[
            ...
            html.Div([dbc.Button("Select All",id='select-all',n_clicks=0,color='primary'),
                    ...
                    dbc.Button("Add custom field",id='add-col',n_clicks=0,color='primary'),
            ...
            dbc.Row([
                dbc.Col(html.Div([
                    ...
                    html.Div([dcc.Markdown("### Modify Data: "),
                              dcc.Dropdown(id='mod-selection',options=data_modifications,value=None,style={'width':'75%'}),
                              dbc.Button("apply",id='mod-data',n_clicks=0,color='success')],
                              className ="d-grid gap-2 d-md-flex",
                              style={'padding':10}),
                    ...
                    html.Div([dbc.Button("Show Limit of Detection",id='lod',n_clicks=0,color='dark'),
                              ...
                              dbc.Button("Custom plot",id='custom-plot',n_clicks=0,color='dark'),
                              dcc.Dropdown([], value=None, id='xaxis',style={'width':'50%'}),],
                              className ="d-grid gap-2 d-md-flex",
                              style={'padding':10}),
                ],
                ),),
